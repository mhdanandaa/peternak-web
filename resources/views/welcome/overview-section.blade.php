  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      ...
      <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
        <h1 class="title-font lg:text-4xl text-4xl font-bold mb-4 text-white p-2 border-b-2 border-purple-400 text-border-white text-border-size-2 backdrop-blur-sm uppercase">Pendahuluan
        </h1>
        ...
        <div class="flex justify-center">
          <a href="{{route('modulePage')}}" class="inline-flex text-white bg-ungu-font border-0 py-2 px-6 focus:outline-none hover:bg-purple-400 rounded text-lg backdrop-blur-sm">Pendahuluan</a>
        </div>
      </div>
    </div>
  </section>
