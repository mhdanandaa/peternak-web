<x-my-app-layout>
    ...
    <div class="circlePosition md:w-[2500px] w-[350px] md:h-[500px] h-[1000px] bg-ungu-font rounded-[100%] absolute md:top-[50%] top-[110%] md:left-[10%] left-[60%] translate-x-[-50%] traslate-y-[-50%] blur-[100px]"></div>
