        ...
        {{-- @dump($video) --}}
            <div class="container mx-auto flex px-2 py-5 md:flex-row flex-col items-center">
                ...
                <div
                    ...
                    <h1 class="title-font  text-3xl mb-4 font-medium text-gray-900" name="videoTitle">
                        {{ $video['snippet']['title'] }}
                    </h1>
                    ...
                    <div class="w-full flex">
                        <a href="{{ route('videoPage', ['playlist_id'=>$video['snippet']['playlistId'],'video_id' => $video['contentDetails']['videoId']]) }}"
                            class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-sm">Lihat
                            detail</a>
                        <div class="flex">
